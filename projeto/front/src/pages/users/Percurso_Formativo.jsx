...
import CertificadoModal from '../../components/cursos/Certificado_Modal';
...
const PercursoFormativo = () => {
  ...
  useEffect(() => {
    const fetchPercursoFormativo = async () => {
      try {
        ...
        console.log('A buscar inscrições do utilizador...');
  ...
  if (loading) {
    return <div className="loading">A carregar seu percurso formativo...</div>;
  }
