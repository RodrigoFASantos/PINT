...
const CursoConteudos = ({ cursoId }) => {
  ...
  // Verificar se o usuário pode editar conteúdos
  const canEdit = userRole === 'admin' || userRole === 'formador';
  ...
  return (
    <div className="curso-conteudos-container">
                            ...
                            {pasta.conteudos && pasta.conteudos.length > 0 ? (
                              pasta.conteudos.map(conteudo => (
                                <div key={conteudo.id_conteudo} className="conteudo-item">
                                  {renderConteudoIcon(conteudo.tipo)}
      ...
      {/* Modal para adição/edição de tópicos, pastas e conteúdos */}
      {showModal && (
